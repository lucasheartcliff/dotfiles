...
function M.get_formatters(bufnr)
  ...
  local null_ls = package.loaded["none-ls"] and require("none-ls.sources").get_available(ft, "NULL_LS_FORMATTING") or {}
  ...
  ---@type lsp.Client[]
  local clients = require("user.util").get_clients({ bufnr = bufnr })
