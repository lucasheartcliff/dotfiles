...
sudo apt install -y build-essential xclip x11-utils libssl-dev libffi-dev git curl wget zsh make zlib1g-dev libbz2-dev libreadline-dev libsqlite3-dev terminator tmux stow
